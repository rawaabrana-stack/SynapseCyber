...
const CSS = `@import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600;9..144,700&family=Manrope:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap');
  :root {
    --bg: #F8FAFC;
    --bg-alt: #F1F5F9;
    --surface: #FFFFFF;
...
export default function SynapseCyber() {
  ...
  useEffect(() => {
    ...
    // ===================================================================
    // NAV SCROLL — transparent -> solid past the hero
    // ===================================================================
    (function () {
    ...
    // ===================================================================
    (function () {
      const canvas = root.querySelector('#footer-canvas');
      if (!canvas) return;
      const renderer = new THREE.WebGLRenderer({ canvas, alpha: true, antialias: true });
      renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2));
      const scene = new THREE.Scene();
        ...
        <footer>
          ...
          <div className="container">
            <div className="footer-top">
              ...
              <div className="footer-col"><h5 data-i18n="footer.company">Company</h5><ul><li><a href="#">About</a></li><li><a href="#">Careers</a></li><li><a href="#">Contact</a></li><li><a href="#quote" data-i18n="footer.quote">Request a Quote</a></li></ul></div>
              <div className="footer-col"><h5 data-i18n="footer.legal">Trust &amp; Legal</h5><ul><li><a href="/trust">Trust &amp; Assurance</a></li><li><a href="/security">Security &amp; Disclosure</a></li><li><a href="/legal/privacy">Privacy Policy</a></li><li><a href="/legal/terms">Terms of Use</a></li><li><a href="/legal/accessibility">Accessibility</a></li></ul></div>
            </div>
