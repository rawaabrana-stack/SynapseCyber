...
export const CSS = `@import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600;9..144,700&family=Manrope:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap');
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .mobile-menu .container { display: flex; flex-direction: column; padding-top: 2px; padding-bottom: 8px; }
  .mobile-menu a { padding: 4px 2px; font-size: 16px; font-weight: 600; color: var(--ink-2); border-bottom: 1px solid var(--line); }
  .mobile-menu a:hover { color: var(--accent); }
  .mobile-menu .mm-cta { margin-top: 2px; }
  ...
  .mm-controls { display:flex; gap:8px; align-items:center; margin-bottom:2px; justify-content:center; }
